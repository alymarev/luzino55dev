...
class UserController extends Controller{
    ...
    public function actionEditProfile(){
        ...
        if ($this->request->change_avatar) {
            ...
            $img = $this->fp->uploadIMG($message_avatar_name, $_FILES["avatar"], Config::MAX_IMAGE_SIZE, Config::DIR_AVATAR);
            if ($img) {
            ...
            if ($user_temp instanceof Users) $this->redirect(URL::current());
        ...
        $this->render($this->renderData(array("form_avatar" => $form_avatar, "form_name" => $form_name, "form_password" => $form_password), "profile", array("avatar" => $this->auth_user->avatar, "max_size" => (Config::MAX_IMAGE_SIZE / 1024))));
    }
